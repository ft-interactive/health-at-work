    ...
    const article = (
      <section className={!this.state.submitted && 'blurred'}>
        <p className="o-typography-body">
          ...
          You guessed {this.state.render.daysGuess} days. {this.state.render.rightWrong || 'You are correct'}: employees earning {renderData.income || this.props.data[0].income} lose <span className="variable">{(this.state.submitted && renderData.absence.days) || renderData.daysGuess}</span> days per year because of absenteeism and presenteeism, according to research for the Britain’s Healthiest Workplace survey. The research was developed by VitalityHealth and produced in association with the Financial Times, Rand Europe, the research consultancy, the University of Cambridge and Mercer, the human resources consultants.
          {/* eslint-enable max-len */}
        </p>

        <p className="o-typography-body">
          {/* eslint-disable max-len */}
          The three most serious issues for employees earning {renderData.income || this.props.data[0].income} are:
          {/* eslint-enable max-len */}
        </p>

        <ol className="o-typography-list o-typography-list--ordered">
          <li>{renderData.mostserious1 || this.props.data[0].mostserious1}</li>
          <li>{renderData.mostserious2 || this.props.data[0].mostserious2}</li>
          <li>{renderData.mostserious3 || this.props.data[0].mostserious3}</li>
        </ol>
        ...
        <p className="o-typography-body">
          {/* eslint-disable max-len */}
          <span className="variable">{renderData.fruitvegpc || this.props.data[0].fruitvegpc}</span> per cent of employees earning {renderData.income || this.props.data[0].income} do not eat at least five portions of fruit and vegetables per day. This compares to 45.5 per cent of all employees in the UK. Britain’s Healthiest Workplace research shows employees with poor diets lose 3.5 productive days per year. Employers are responding <a href="https://www.ft.com/content/f829ff40-3fa2-11e7-82b6-896b95f30f58" target="_blank" rel="noopener noreferrer" className="o-typography-link">with incentives</a> to eat more salad and less fried food.
          {/* eslint-enable max-len */}
        </p>
        ...
        <p className="o-typography-body">
          {/* eslint-disable max-len */}
          <span className="variable">{renderData.smokepc || this.props.data[0].smokepc}</span> per cent of employees earning {renderData.income || this.props.data[0].income} smoke cigarettes, cigars or pipes. This compares to 10.1 per cent of all employees in the UK. While the UK, in common with many other countries around the globe, has laws that prevent smoking in the workplace, China has <a href="https://www.ft.com/content/0817f89c-3fa5-11e7-82b6-896b95f30f58" target="_blank" rel="noopener noreferrer" className="o-typography-link">yet to introduce</a> a national ban and around half of all Chinese men are regular smokers.
          {/* eslint-enable max-len */}
        </p>
        ...
        <p className="o-typography-body">
          {/* eslint-disable max-len */}
          <span className="variable">{renderData.twomscondspc || this.props.data[0].twomscondspc}</span> per cent of employees earning {renderData.income || this.props.data[0].income} have two or more musculoskeletal conditions. This compares to 53.1 per cent of all employees in the UK. For many opioid addicts in the US, their plight started with painkillers for conditions such as these. <a href="https://www.ft.com/content/abf2ccf0-371f-11e7-99bd-13beb0903fa3" target="_blank" rel="noopener noreferrer" className="o-typography-link">US employers</a> have to bear their portion of the blame for the opioid addiction epidemic.
          {/* eslint-enable max-len */}
        </p>
        ...
        <p className="o-typography-body">
          {/* eslint-disable max-len */}
          <span className="variable">{renderData.finconcernspc || this.props.data[0].finconcernspc}</span> per cent of employees earning {renderData.income || this.props.data[0].income} have “a lot of” financial concerns. This compares to 7.3 per cent of all employees in the UK. Nearly <a href="https://www.ft.com/content/38ba3602-3fa7-11e7-82b6-896b95f30f58" target="_blank" rel="noopener noreferrer" className="o-typography-link">half of all</a> employees surveyed for Britain’s Healthiest Workplace indicated they have at least some money worries and are losing six productive days per year — some employers are finding ways to help.
          {/* eslint-enable max-len */}
        </p>
      </section>
    );
