  ...
  return (
    <section className={className}>
      ...
      <p className="o-typography-body">
        ...
        <strong>Muscle and joint problems</strong> affect a very high proportion of workers. As many as <span className="variable">{data.twomscondspc}</span> per cent of employees in your age group complain of having at least two musculoskeletal conditions, compared with an average of 54 per cent for the total sample. Acute back pain and arthritis are among the main reasons behind absence from work, particularly in jobs that require more physical activity.
      ...
      <p className="o-typography-body">
        {/* eslint-disable max-len */}
        <span className="variable">{data.fruitvegpc}</span> per cent of employees in this age group fail to eat at least <strong>five portions of fruit and vegetables</strong> per day, compared with an average of 65 per cent for all employees. Poor diets can contribute to tiredness, stress and ineffectiveness at work.
        {/* eslint-enable max-len */}
      </p>

      <p className="o-typography-body">
        {/* eslint-disable max-len */}
        The share of employees aged {selectedDimension} considered <strong>physically inactive</strong>, because they spend less than 2.5 hours exercising each week, is <span className="variable">{data.physicallyinactivepc}</span> per cent. This compares with an average of 33 per cent for all employees. Exercise can have a positive impact on concentration at work and can prevent longer-term problems such as heart disease.
        {/* eslint-enable max-len */}
      </p>

      <p className="o-typography-body">
        {/* eslint-disable max-len */}
        This year, <span className="variable">{data.obesepc}</span> per cent of employees aged {selectedDimension} have been classed as <strong>obese</strong>, meaning they have a body mass index of 30 or above. This compares with an average of 20 per cent for all employees — a figure that has been steadily rising over the past five years.
        {/* eslint-enable max-len */}
      </p>
      ...
      <p className="o-typography-body">
        {/* eslint-disable max-len */}
        <span className="variable">{data.smokepc}</span> per cent of employees in your age group <strong>smoke</strong> cigarettes, cigars or pipes, compared with 10 per cent of all employees. This figure been falling steadily over the past five years. 
        {/* eslint-enable max-len */}
      </p>
      ...
      <p className="o-typography-body">
        {/* eslint-disable max-len */}
        <span className="variable">{data.twoplusstressdimensions}</span> per cent of employees aged {selectedDimension} say they have been affected by two or more types of work-related <strong>stress</strong>, such as a lack of choice over type of work, not receiving respect from colleagues, experiencing strained relationships with colleagues or lacking clarity on their duties and responsibilities. On average, 26 per cent of those surveyed say they have experienced at least two of these types of stress.
        {/* eslint-enable max-len */}
      </p>
      <p className="o-typography-body">
        {/* eslint-disable max-len */}
        <span className="variable">{data.sleeppc}</span> per cent in your age group say they <strong>sleep</strong> fewer than seven hours a night, compared with 35 per cent of all employees. An even higher percentage claim to have difficulties sleeping, while more than 60 per cent say they feel tired at work at least once a week.
        {/* eslint-enable max-len */}
      </p>
      <p className="o-typography-body">
        {/* eslint-disable max-len */}
