      ...
      if (this._isMounted) {
        ...
        switch (newLayout) {
          case 'XL':
            this.setState({
              layout: newLayout,
              graphicsDimensions: { width: 1180, height: 600 },
              gutters: 20,
            });
          ...
          case 'L':
            this.setState({
              layout: newLayout,
              graphicsDimensions: { width: 940, height: 478 },
              gutters: 20,
            });
          ...
          case 'M':
            this.setState({
              layout: newLayout,
              graphicsDimensions: { width: 700, height: 356 },
              gutters: 20,
            });
          ...
          case 'S':
            this.setState({
              layout: newLayout,
              graphicsDimensions: { width: 470, height: 2660 },
              gutters: 20,
            });
          ...
          default:
            this.setState({
              layout: newLayout,
              graphicsDimensions: { width: 300, height: 1670 },
              gutters: 10,
            });
        }
      }
